...
class User(UserMixin, db.Model):
    ...
    # Relationships
    role_obj = db.relationship('Role', foreign_keys=[role_id], overlaps="user_role,users")
...
class ProspectingCampaign(db.Model):
    ...
    name = db.Column(db.String(200), nullable=False)
    description = db.Column(db.Text, nullable=True)
    target_segment = db.Column(db.Text, nullable=True)
    objective = db.Column(db.Text, nullable=True)
    tone_of_voice = db.Column(db.Text, nullable=True)
    offer = db.Column(db.Text, nullable=True)
    main_angle = db.Column(db.Text, nullable=True)
    default_cta = db.Column(db.Text, nullable=True)
