...
# Markdown/HTML Mixed Content for better layout control
# Using HTML tables for signatures ensures they stay side-by-side even when converted to PDF/Viewed
contract_content = """
...
Fica eleito o Foro da Comarca de **{{FORO_COMPLETO}}**, para dirimir todas e quaisquer dúvidas oriundas deste contrato, com renúncia de qualquer outro por mais privilegiado que seja.
...
<p align="center" style="margin-top: 40px; margin-bottom: 40px;"><strong>{{CIDADE_ASSINATURA}}, {{DATA_ASSINATURA}}.</strong></p>

<!-- Signatures Table -->
<table width="100%" border="0" cellspacing="0" cellpadding="0" style="margin-top: 20px; page-break-inside: avoid;">
    <tr>
        <td width="45%" align="center" valign="top">
            <div style="border-top: 1px solid #000; width: 90%; margin: 0 auto; padding-top: 5px;">
                <strong>{{CONTRATANTE_ASSINATURA_NOME}}</strong><br>
                <span>CNPJ: {{CONTRATANTE_CNPJ}}</span>
            </div>
        </td>
        <td width="10%"></td>
        <td width="45%" align="center" valign="top">
            <div style="border-top: 1px solid #000; width: 90%; margin: 0 auto; padding-top: 5px;">
                <strong>{{CONTRATADA_ASSINATURA_NOME}}</strong><br>
                <span>CNPJ: {{CONTRATADA_CNPJ}}</span>
            </div>
        </td>
    </tr>
</table>
...
<table width="100%" border="0" cellspacing="0" cellpadding="0" style="margin-top: 20px; page-break-inside: avoid;">
    <tr>
        <td width="45%" align="center" valign="top">
            <div style="border-top: 1px solid #000; width: 90%; margin: 0 auto; padding-top: 5px;">
                <strong>{{TESTEMUNHA1_NOME}}</strong><br>
                <span>CPF: {{TESTEMUNHA1_CPF}}</span>
            </div>
        </td>
        <td width="10%"></td>
        <td width="45%" align="center" valign="top">
            <div style="border-top: 1px solid #000; width: 90%; margin: 0 auto; padding-top: 5px;">
                <strong>{{TESTEMUNHA2_NOME}}</strong><br>
                <span>CPF: {{TESTEMUNHA2_CPF}}</span>
            </div>
        </td>
    </tr>
</table>
...
html_content = markdown.markdown(contract_content)
